  ...
  skills: Skill[] = [
    {
      id: 1,
      name: 'HTML',
      additional: 'HTML5, ARIA, SVG, Semantic HTML',
    ...
    },
    {
      id: 2,
      name: 'CSS',
      additional: 'CSS Grid, Flexbox, Media Queries, BEM, Bootstrap, Kendo UI',
    ...
    },
    {
      id: 5,
      name: 'Angular',
      additional: 'Component-Based Architecture',
    ...
    },
    {
      id: 6,
      name: 'JavaScript',
      additional: 'Angular, Leaflet.js, Handlebars.js',
    ...
    },
    {
      id: 9,
      name: 'GIT',
      additional: 'GitHub, GitLab, Bitbucket, Jira',
